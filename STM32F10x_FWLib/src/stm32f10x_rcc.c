...
/*******************************************************************************
* Function Name  : RCC_DeInit   RCC  恢复其默认设置
...
{
  /* Set HSION bit  内部8M振荡器开启*/
  RCC->CR |= (u32)0x00000001;

  /* Reset SW[1:0], HPRE[3:0], PPRE1[2:0], PPRE2[2:0], ADCPRE[1:0] and MCO[2:0] bits */
  /* HSI做内部时钟、SYSCLK不分频、HCLK不分频、PCLK 2 分频做ADC时钟、系统无时钟输出 */
...
/*******************************************************************************
* Function Name  : RCC_HSEConfig    外部时钟的管理
...
*                       - RCC_HSE_OFF: HSE oscillator OFF  外部时钟关闭
*                       - RCC_HSE_ON: HSE oscillator ON    外部时钟开启
*                       - RCC_HSE_Bypass: HSE oscillator bypassed with external 外部时钟被旁路
*                         clock
* Output         : None
* Return         : None
*******************************************************************************/
...
/*******************************************************************************
* Function Name  : RCC_WaitForHSEStartUp  等待外部时钟生效
* Description    : Waits for HSE start-up.
* Input          : None
* Output         : None
* Return         : An ErrorStatus enumuration value:   返回成功或失败
